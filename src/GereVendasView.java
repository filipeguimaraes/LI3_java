...
public class GereVendasView implements InterfGereVendasView {
    ...
    public void query2(int[] global, int[] filial1,int[] filial2,int[] filial3){
        ...
        System.out.println(CYAN+"     Número total de vendas: "+RESET+global[0]);
        ...
        System.out.println(CYAN+"     Número total de vendas: "+RESET+filial1[0]);
        ...
        System.out.println(CYAN+"     Número total de vendas: "+RESET+filial2[0]);
        ...
        System.out.println(CYAN+"     Número total de vendas: "+RESET+filial3[0]);
